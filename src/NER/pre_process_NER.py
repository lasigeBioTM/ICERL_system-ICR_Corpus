...
def cantemist_to_IOB2(subset):
    ...
    if subset == "train":
        cantemist_data_dir = './data/train-set-to-publish/cantemist-ner/'

    elif subset == "dev":
        cantemist_data_dir = './data/dev-set1-to-publish/cantemist-ner/'

    elif subset == "test":
        cantemist_data_dir = './data/dev-set2-to-publish/cantemist-ner/'
        #cantemist_data_dir = './data/pt/'
    ...
    if not os.path.exists("./data/iob2/"):
        os.makedirs("./data/iob2/")
    if not os.path.exists("./data/iob2/train_es/"):
        os.makedirs("./data/iob2/train_es/")

    with open("./data/iob2/train_es/"+ subset + ".txt", 'w') as output_file:
...
def prepare_mesinesp_for_flair_embeds_training():
    ...
    output_dir = "./data/mesinesp/"
    
    
    if not os.path.exists("./data/mesinesp/mesinesp_1/train/"):
        os.makedirs("./data/mesinesp/mesinesp_1/train/")
    
    if not os.path.exists("./data/mesinesp/mesinesp_2/train/"):
        os.makedirs("./data/mesinesp/mesinesp_2/train/")

    if not os.path.exists("./data/mesinesp/mesinesp_3/train/"):
        os.makedirs("./data/mesinesp/mesinesp_3/train/")
    
    if not os.path.exists("./data/mesinesp/mesinesp_4/train/"):
        os.makedirs("./data/mesinesp/mesinesp_4/train/")
...
def pre_process_pt_abstracts_for_flair_embeds_training():
    dir_abstract = "./data/pre_pt_scielo_abtracts_embeddings/"

    filenames = os.listdir(dir_abstract)
    ...
    out_dir_train = "./data/pt_scielo_abstracts_embeddings/train/"
    if not os.path.exists(out_dir_train):
            os.makedirs(out_dir_train,exist_ok=True)
            
    for file in train_filenames:
        shutil.copy(os.path.join(dir_abstract, file), out_dir_train)

    for file in dev_filenames:
            with open("./data/pt_scielo_abstracts_embeddings/" + "valid.txt","w",encoding = "utf-8") as devfile:
                    for names in dev_filenames:
                            with open(dir_abstract + names) as infile:
                                    devfile.write(infile.read())
                            devfile.write("\n")
                            devfile.write("\n")
    for file in test_filenames:
            with open("./data/pt_scielo_abstracts_embeddings/" + "test.txt","w",encoding = "utf-8") as testfile:
                    for names in test_filenames:
                            with open(dir_abstract + names) as infile:
                                    testfile.write(infile.read())
                            testfile.write("\n")
                            testfile.write("\n")
...
def pt_train_to_IOB2():
    ...
    #if subset == "train":
    cantemist_data_dir = './data/train_pt_files/'
    ...
    #Create a file with the text of all documents tokenized and tagged
    if not os.path.exists("./data/iob2/train_pt/"):
        os.makedirs("./data/iob2/train_pt/")

    with open("./data/iob2/train_pt/train.txt", 'w',encoding = 'utf-8') as output_file:
        output_file.write(output)
        output_file.close()
