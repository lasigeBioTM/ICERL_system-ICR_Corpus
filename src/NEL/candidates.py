...
def generate_candidates_for_entity(entity_text, name_to_id, name_to_id_2, named_to_id_3, synonym_to_id, min_match_score, ontology_graph, ontology_graph_2, ontology_graph_3, ont_number, synonym_to_id_3):
    ...
    if ont_number == "multi_ont": # Add the candidates from ICD10-CM
        ...
        decs_candidates = map_to_decs(entity_text, named_to_id_3, synonym_to_id_3)
            ...
            if candidate_match["match_score"] > min_match_score:
                ...
                if candidate_match["ontology_id"][0] == "D" or candidate_match["ontology_id"][0] == "C": #ICD10-CM candidate
                    ...
                    if "/" in candidate_match["ontology_id"]: #CIEO3 candidate
                        ...
                        candidate_id = int(candidate_match["ontology_id"].replace("/", "").replace("H", ""))
