...
def build_entity_candidate_dict(annotations, model, min_match_score, ontology_graph, ontology_graph_2, ontology_graph_3, name_to_id, name_to_id_2, name_to_id_3, synonym_to_id, ont_number, synonym_to_id_3):
        ...
        for annotation in annotations[document]:
            ...
            if normalized_text in document_entities: # Repeated instances of the same entity count as one instance
                ...
                entity_dict[normalized_text]= generate_candidates_for_entity(normalized_text, name_to_id, name_to_id_2, name_to_id_3, \
                                                                            ...
                                                                            ontology_graph_2, ontology_graph_3, ont_number, synonym_to_id_3)
...
def pre_process():
    ...
    ont_number = str(sys.argv[1]) # ontologies to consider: multi_ont (CIEO3, ICD10CM and DeCS)
    model = "ppr_ic" 
    ...
    if ont_number == "multi_ont": 
        ...
        ontology_graph_3, name_to_id_3, synonym_to_id_3 = load_decs()
    ...
    documents_entity_list = build_entity_candidate_dict(annotations, model, min_match_score, ontology_graph, ontology_graph_2,\
                                                                ...
                                                                synonym_to_id, ont_number, synonym_to_id_3)
    ...
    # Create file with the information content of each CIEO/CID and DeCS candidate appearing in candidates files (to use in ppr_ic model) 
    if model != "string_matching":
