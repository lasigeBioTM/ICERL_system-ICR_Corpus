...
def generate_ic_file(annotations, ontology_graph, ont_number):
    """Generate file with information content of all CIEO/CID and DeCS entities appearing in candidates files."""
    ...
    for doc in os.listdir(candidates_dir): 
        ...
        for line in data.split('\n'):
            ...
            if url in url_temp:
                ...
                if url != "" and url[0].isdigit(): #Only consider CIEO3 and DeCS
                    #print(url)
                    url_temp.append(url)
